...
function animate() {
    // Rotate the city around the Y-axis
    city.rotation.y += 0.005;  // Adjust the value for faster or slower rotation
...
function storeEmail() {
    ...
    if (validateEmail(email)) {
        // Storing in local storage for demonstration purposes
...
document.querySelector("#__next > div > main > div > div.animation-delay-2.z-30.flex.h-10.flex-row.items-center.space-x-4.fade-in")
